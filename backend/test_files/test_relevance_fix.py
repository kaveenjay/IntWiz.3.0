"""
Test script to verify the relevance score fix on old interview transcripts.

Run from the backend folder with:
    python test_files/test_relevance_fix.py
...
# Add parent directory to path so we can import audio_utils
...
from audio_utils import calculate_relevance_score
...
# ===== Old transcripts and their previous relevance scores =====
TEST_CASES = [
    {
...
def main():
    print("=" * 70)
    print("RELEVANCE SCORE FIX — TEST RUN")
    print("=" * 70)

    reference = CV_TEXT + " " + JD_TEXT
    ...
    for i, case in enumerate(TEST_CASES, 1):
        ...
        new_score = calculate_relevance_score(case["transcript"], reference)
